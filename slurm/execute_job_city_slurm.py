...
import argparse
import osmnx
from linear_programs.execute import execute_LPs


def process_job(city:str, line:str,method:str):
    """Gets city name and information about combination. Starts with getting the right graph and the execution of the LPs
    ...
    execute_LPs(city, origin_name, origin_coordinates, arrival_name, arrival_coordinates, G, 1000, 1, method)
