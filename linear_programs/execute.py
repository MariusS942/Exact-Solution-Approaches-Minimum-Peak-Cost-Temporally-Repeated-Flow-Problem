...
from T_R_Min_Peak_LP import solve_LP
from T_R_Min_Peak_LP_Row_Generation import solve_LP_Row_Generation
...
def execute_LPs(city: str, origin: str, origin_coordinates: tuple, arrival: str, arrival_coordinates: tuple, Graph: networkx.MultiGraph, T:int, repeats: int, method:str):
    ...
    for i in range(1,repeats+1):
        ...
        if  method  == 'LP':
            obj_val_LP = solve_LP(H,T,0.8 *v_best,s,t)

        elif method == 'LP_row':
            obj_val_LP_Row = solve_LP_Row_Generation(H,T,0.8*v_best,s,t)

        elif method == 'Heu_n':
            obj_val_heu = solve_heuristic(H,T,0.8*v_best,1,s,t)

        elif method == 'Heu_n^2':
            obj_val_heu = solve_heuristic(H,T,0.8*v_best,2,s,t)