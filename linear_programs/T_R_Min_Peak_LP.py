...
def solve_LP(Graph: networkx.DiGraph, T:int, v_best:float, s,t) -> float:
    """Solves the MPC TRF problem on a given graph with given time horizon T and minimum flow value v_best via a LP. Prints the used path with flow rate and total flow and returns the peak costs
    ...
    print('Runtime LP Overall:', end_time_all-start_time_all)
    ...
    if model.Status != GRB.INFEASIBLE:
        print('Peak-Cost LP:', model.ObjVal)
